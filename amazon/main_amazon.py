...
def main():
    ...
    df = pd.read_csv('C:/Users/Chris/Desktop/2018-1/Text Mining/project/amazon/pre_review.csv', encoding='cp949')
    predoc = df['review'].values.tolist()
    print(len(predoc))
    ...
    result = corpus.plsa(number_of_topics=3, max_iter=100, lambda_b=0.5)
